...
//     const validationResult = createPostSchema.shape.booktitle.safeParse(title);
//     if (!validationResult.success) {
//       setBookTitleError(validationResult.error.issues[0].message);
//     } else {
//       setBookTitleError("");
//     }
//     setBookTitle(title);
...
//       createPostSchema.shape.bookauthor.safeParse(author);
//     if (!validationResult.success) {
//       setBookAuthorError(validationResult.error.issues[0].message);
//     } else {
//       setBookAuthorError("");
//     }
...
//             />
//             {bookTitleError && (
//               <div className="text-red-500">{bookTitleError}</div>
//             )}
//             <Input
//               placeholder="저자 (선택사항)"
//               value={bookauthor}
...
//             />
//             {bookAuthorError && (
//               <div className="text-red-500">{bookAuthorError}</div>
//             )}
//           </div>
//           <EditorContent
//             editor={editor}
